...
data = memory.read(SHM_SIZE)
print(f"[Python] Data read from shared memory: {data[:2]}")
...
memory.write(filetype.encode())
print(f"[Python] Data written to shared memory: {filetype}")
